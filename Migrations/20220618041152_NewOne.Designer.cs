...
namespace MovieSearchAPI.Migrations
{
    ...
    [Migration("20220618041152_NewOne")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieSearchAPI.DataModels.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MovieSearchAPI.DataModels.List", b =>
                {
                    b.HasOne("MovieSearchAPI.DataModels.WatchList", "WatchList")
                        .WithMany()
            ...
            modelBuilder.Entity("MovieSearchAPI.DataModels.WatchList", b =>
                {
                    b.HasOne("MovieSearchAPI.DataModels.Movie", "Movie")
                        .WithMany()
